...
local ERROR_PATTERNS = {
  ...
  {
    pattern = '[Aa]uthentication failed',
    category = ERROR_CATEGORIES.AUTH,
    message = 'Authentication failed. Check your credentials.',
  },
  { pattern = 'API [Tt]oken', category = ERROR_CATEGORIES.AUTH, message = 'API token is invalid or expired.' },
  {
    pattern = '[Ii]nvalid [Cc]redentials',
    category = ERROR_CATEGORIES.AUTH,
    message = 'Invalid credentials. Please check your Jira email and API token.',
  },
  {
    pattern = '[Ll]ogin [Ff]ailed',
    category = ERROR_CATEGORIES.AUTH,
    message = 'Login failed. Check your Jira email and API token.',
  },
  ...
  {
    pattern = '[Pp]ermission [Dd]enied',
    category = ERROR_CATEGORIES.PERMISSION,
    message = "Permission denied. You don't have access to this resource.",
  },
  {
    pattern = '[Nn]ot [Aa]uthorized',
    category = ERROR_CATEGORIES.PERMISSION,
    message = "Not authorized. You don't have permission to perform this action.",
  },
  ...
  -- Not Found errors
  {
    ...
    message = 'Resource not found. Check that the issue or project exists.',
  },
  {
    pattern = '[Nn]ot [Ff]ound',
    category = ERROR_CATEGORIES.NOT_FOUND,
    message = 'Resource not found. Check that the issue or project exists.',
  },
  {
  ...
  {
    pattern = '[Rr]equired field',
    category = ERROR_CATEGORIES.VALIDATION,
    message = 'Missing required field. Check your input.',
  },
  {
  ...
  {
    pattern = '[Ss]erver [Ee]rror',
    category = ERROR_CATEGORIES.SERVER,
    message = 'Jira server error. Please try again later.',
  },
  {
    pattern = '[Ii]nternal [Ee]rror',
    category = ERROR_CATEGORIES.SERVER,
    message = 'Jira internal error. Please try again later.',
  },
  ...
  { pattern = '[Nn]etwork', category = ERROR_CATEGORIES.NETWORK, message = 'Network error. Check your connection.' },
  {
    ...
    message = 'Request timed out. Check your connection or try again later.',
  },
  {
    pattern = '[Cc]onnection [Rr]efused',
    category = ERROR_CATEGORIES.NETWORK,
    message = 'Connection refused. Check your Jira URL or network settings.',
  },
}
