...
function M.show_help()
  local help_text = {
    ...
    '  - Markdown Preview: Press <C-p> in issue creation form to toggle preview',
    '  - Issue Templates: Press <C-t> to apply template based on issue type',
    '  - Autocompletion: Type in any field for context-aware suggestions',
    '',
    'Commands:',
    ...
    '',
    '-- Dashboard and Context Commands:',
    ...
    '  :JiraCommit                 - Create git commit with Jira issue key',
    '  :JiraCreateBranch           - Create git branch from Jira issue',
    '  :JiraViewUnderCursor        - View Jira issue under cursor',
    '  :JiraOpenUnderCursor        - Open Jira issue under cursor in browser',
    '',
    '-- Git Workflow Integration:',
    '  :JiraGitBranch              - Create git branch from issue with prefix selector',
    '  :JiraGitCommitHistory       - Show commit history with Jira links',
    '  :JiraGitLinkCommit [hash] [key] - Link a commit to a Jira issue',
    '  :JiraGitUpdateIssue         - Update Jira issue with branch info',
    '  :JiraGitHooks               - Show Git workflow hooks help',
    '  :JiraInstallGitHooks        - Install Git hooks for Jira integration',
    '',
    '-- LSP/Editor Integration:',
    '  :JiraEnableLsp              - Enable LSP integration features',
    '  :JiraHighlightKeys          - Highlight Jira issue keys in current buffer',
    '',
    '-- Performance & Caching:',
    '  :JiraCacheStats             - Show API cache statistics',
    '  :JiraCacheClear [type]      - Clear API cache (optional: specify cache type)',
    '',
    '-- Troubleshooting:',
    '  :JiraTroubleshoot           - Show troubleshooting guide with common issues',
    '',
    ...
    '  :JiraDashboard  # Opens your personalized Jira dashboard',
    '  :JiraContext  # Shows Jira issues from current context (branch/file)',
    '  :JiraCreateBranch  # Creates a git branch from a Jira issue',
    '  :JiraCommit  # Creates a git commit with Jira issue key from branch',
    '  :JiraViewUnderCursor  # Views details of Jira issue under cursor',
    '  :JiraGitBranch  # Creates a git branch with prefix (feature/bugfix) from an issue',
    '  :JiraGitCommitHistory  # Shows recent commits with Jira issue links',
    '  :JiraGitLinkCommit HEAD PROJ-123  # Links the latest commit to PROJ-123',
    '  :JiraInstallGitHooks  # Installs Git hooks for automatic Jira integration',
    '  :JiraEnableLsp  # Enables LSP integration with hover info and code actions',
    '  :JiraHighlightKeys  # Highlights Jira issue keys with status in current file',
    '  :JiraCacheStats  # Shows API cache hit rates and statistics',
    '  :JiraCacheClear issues  # Clears the issues cache only',
    '  :JiraCacheClear  # Clears all caches',
    '  :JiraTroubleshoot  # Shows troubleshooting guide for common issues',
    '',
    'Configuration:',
